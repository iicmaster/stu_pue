...
class Thaidate 
{
	...
	public function getDateTime() 
	{
		...
		if(!$this->_th_date = self::convert_date())
		{
	...
	public function convert_date($date, $format) 
	{
		...
		$this->_th_time	 = ($this->_format != 'E4') ? $this->_hour.':'.$this->_minute.' น.' : date("g:i A", mktime($this->_hour, $this->_minute, 0, 0, 0, 0));
		...
		switch($this->_format) 
		{
			...
			case 'E3'	: $this->_th_date = $this->_day.'/'.intval($this->_month).'/'.$this->_th_year.' '.$this->_th_time; break;
			...
			case 'G3'	: $this->_th_date = $this->_day.' '.$this->_th_month.' '.$this->_th_year; break;
			case 'G4'	: $this->_th_date = $this->_day.' '.$this->_th_month.' '.$this->_th_year.', '.$this->_th_time; break;
		}	

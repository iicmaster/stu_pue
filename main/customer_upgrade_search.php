...
$(function(){
	...
	$("#customer_type").val('<?php echo (isset($_POST['customer_type'])) ? $_POST['customer_type'] : '0' ?>');
...
<div id="container">
	...
	<div id="content">
		...
		<div id="search_section">
			<form method="post" action="customer_upgrade_search.php">
		...
		<table width="100%" border="1" cellpadding="5" cellspacing="0">
			...
			if(isset($_POST['submit']))
			{
				...
				if($query_rows > 0)
				{
					...
					{
						$button = '<a href="customer_upgrade.php?id='.$data['id'].'">เปลี่ยนประเภทสมาชิก</a>';

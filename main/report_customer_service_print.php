...
<title>รายงานการเข้าใช้บริการของลูกค้า</title>
...
<div id="paper">
	<table width="100%">
		...
		<tr>
			<td><h1 align="center">รายงานการเข้าใช้บริการของลูกค้า</h1></td>
		</tr>
		<tr>
		...
		<tr>
			<td>ชื่อลูกค้า : <?php echo $data['name'].' '.$data['lastname'].' ('.$data['nickname'].')'; ?></td>
		</tr>
	</table>
	<table width="100%" class="border">
		...
		<tbody>
			...
			$sql = 'SELECT 
					...
					ORDER BY order_head.date_create DESC';
			...
			<tr>
				...
				<td align="center"><?php echo change_date_time_format($data['date_due']) ?></td>
